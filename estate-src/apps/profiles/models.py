...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_('Phone NUmber'), max_length=30, default='+000000000000')
    ...
    country = CountryField(verbose_name=_('Country'), default='Tartaria', blank=False, null=False)
    city = models.CharField(verbose_name=_('City'), max_length=180, default='Moscowia', blank=False, null=False)
